...
INSERT INTO public.inventory (
    ...
    ('FBI', 'Surveillance Van', '2016', 'Do you like police shows? You will feel right at home driving this van, comes complete with surveillance equipment for and extra fee of $2,000 a month.', '/images/survan.jpg', '/images/survan-tn.jpg', 20000, 19851, 'Brown', 1),
...
-- Task 4: Modify "GM Hummer" description (from Task 1)
UPDATE inventory
SET inv_description = REPLACE(inv_description, 'the small interiors', 'a huge interior')
WHERE inv_make = 'GM' AND inv_model = 'Hummer';

-- Task 6: Update inventory image paths (from Task 1)
UPDATE inventory
SET 
